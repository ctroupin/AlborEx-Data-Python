...
The mission took place from May 25 and 31, 2014 in the Alboran Sea frontal system \citep{CHENEY78,TINTORE91}, scene of the confluence of Atlantic and Mediterranean waters. While the present papers focuses solely on the original dataset, the mission itself is exensively presented in \citet{RUIZ2015} and the features and processes captured by the observations are discussed in \citet{PASCUAL2017}. \citet{OLITA17} examined the deep chlorophyll maximum variation combining the bio-physical data from the gliders and the Arglo floats.

\subsection{Study area}

The particularity of the mission design is that the exact sampling area was not firmly decided until a few days before the start. Prior to the experiment, satellite images of sea surface temperature (SST) and chlorophyll-a (chl-a) concentration were acquired in order to provide an overview of the surface oceanic features apparent in the Alboran Sea. A well-defined front (Fig.~\ref{fig1:SST}) separating Atlantic and Mediterranean waters and exhibiting filament-like structures was selected as the study area (see rectangular box in Fig.~\ref{fig1:SST}). 

The pair of images indicates that the front position slightly changed between May 25 and 30, 2014. An anticyclonic eddy centered around 36$^{\circ}$30'N, 0.5$^{\circ}$W, according to altimetry data, slowly followed an eastward trajectory in the following days. Other SST images during the period of interest displayed different temperature values near the front, yet the front position remains stable. 
