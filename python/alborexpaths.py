...
print("importing configuration from {}".format(__name__))
...
# local files
coastfile = os.path.join(datadir, "coastline_f.dat")
altimetryfile = os.path.join(datadir, "alborex_mean_sla.nc")
ctdlegs = [os.path.join(datadir, "ctd_positions_Leg1.txt"),
           os.path.join(datadir, "ctd_positions_Leg2.txt")
           ]
sstfiles = [os.path.join(datadir, "A2014145125000.L2_LAC_SST.nc"),
            os.path.join(datadir, "A2014150020500.L2_LAC_SST.nc")
           ]
frontfile = os.path.join(datadir, "front_coordinates.dat")

jetfiles = [os.path.join(datadir, "AtlanticJet3.dat"),
            os.path.join(datadir, "AtlanticJet4.dat")
            ]
...
gliderfilesL2 = ["http://thredds.socib.es/thredds/dodsC/auv/glider/icoast00-ime_slcost000/L2/2014/dep0005_icoast00_ime-slcost000_L2_2014-05-25_data_dt.nc",
               "http://thredds.socib.es/thredds/dodsC/auv/glider/ideep00-ime_sldeep000/L2/2014/dep0012_ideep00_ime-sldeep000_L2_2014-05-25_data_dt.nc"]
